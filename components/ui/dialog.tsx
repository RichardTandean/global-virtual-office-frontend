  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        ...
        "duration-(--dur-modal-enter) ease-(--ease-out)",
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          "rounded-lg bg-elevated p-6 text-[13px] text-ink",
...
function DialogTitle({ className, ...props }: DialogPrimitive.Title.Props) {
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "text-[16px] leading-tight font-semibold tracking-tight text-ink",
        className
      )}
      {...props}
    />
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn("text-[13px] text-ink-secondary leading-relaxed", className)}
      {...props}
    />
  )
}
